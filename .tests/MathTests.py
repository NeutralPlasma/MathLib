...
def test_sub():
    ...
    assert main.subtract(3, -1) == -1
    assert main.subtract(3, 0) == 0
    assert main.subtract(3, 1) == 2


def test_mul():
    assert main.multiply(3, 3) == 6
    assert main.multiply(3, -1) == -1
    assert main.multiply(3, 0) == 0
    assert main.multiply(3, 1) == 2


def test_div():
    assert main.divide(3, 3) == 1
    assert main.divide(3, -1) == -1
    assert main.divide(3, 0) == 0
